...
\subsection{The Importance Of Order And Unique Pairs}
...
% There should be an image supporting this...
...
One of the many benefits of triplet loss is its ability to manage inter-class variances, because it isn't forced to bring embedded images into one point, rather just distanced from negative data points by a margin\autocite{yusuf_sar}.
