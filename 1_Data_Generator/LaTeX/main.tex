...
\renewcommand{\maketitlehookd}{%
	\begin{abstract}
		\noindent Applying similarity learning methods in classification problems allows for extremely accurate classification with the downside of longer classification times. This paper explores many different methods in which similarity learning algorithms can be applied to classic classification problems, primarily regarding the Siamese NN architecture.
	\end{abstract}
}
